...
- **Graph *navigation* lags on very large graphs ("nice to have", not blocking).**
  ...
  instanced node spheres) are unexplored. Explicitly user-flagged non-blocking. **(Update: the merged-geometry one-draw-call lever shipped in #61; edge-LOD / culling / instanced nodes remain unexplored. Still open, still non-blocking.)**
