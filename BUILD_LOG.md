...
**Walk-UX pass since the desktop switch (#35, #37, #39 — all frontend-only,
...
reads as work; it also adds a force ⇄ DAG **layout dropdown**. See the #39 entry
for the full triple. The next perceptual confirmation is the user's desktop run.
